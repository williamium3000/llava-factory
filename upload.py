...
from to_upload.model.modeling_tinyllava import TinyLlavaForConditionalGeneration, TinyLlavaPreTrainedModel
from to_upload.model.configuration_tinyllava import TinyLlavaConfig
...
def load_model(model_name_or_path, load_type='hf', load_8bit=False, load_4bit=False, device_map="auto",
                          device="cuda", **kwargs):
...
TinyLlavaConfig.register_for_auto_class()
TinyLlavaPreTrainedModel.register_for_auto_class("AutoModel")
TinyLlavaForConditionalGeneration.register_for_auto_class("AutoModelForCausalLM")

model, tokenizer, image_processor, context_len = load_model("work_dirs/llava-Qwen3-8B-clip-vit-large-patch14-336-base-finetune")
model.push_to_hub("williamium/llava-factory-test")
tokenizer.push_to_hub("williamium/llava-factory-test")
image_processor.push_to_hub("williamium/llava-factory-test")