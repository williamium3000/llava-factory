...
FINETUNE_DATA_PATH=/home/greenland-user/mydata/image/llava/sft/llava_v1_5_mix665k_v1-14a-700k_merged.json   #finetune annotation file path
...
FINETUNE_IMAGE_PATH=/home/greenland-user/mydata/image/llava/sft/ #finetune image dir


LLM_VERSION=lmsys/vicuna-7b-v1.5 # llm path in huggingface
